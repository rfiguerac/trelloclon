...
export const CardBoard = (board: Board) => {
  ...
  return (
    <button
      ...
      key={board.Id}
      className="board-card bg-base-200 rounded-lg shadow-md overflow-hidden cursor-pointer flex flex-col min-h-[120px] transform transition-all duration-200 hover:translate-y-[-5px] hover:shadow-xl">
      <div
        className={`card-header h-[60px] flex items-center justify-center font-bold text-xl bg-cover bg-center ${bg}`}></div>
